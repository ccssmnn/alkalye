		...
		>
			...
			>
				<SliderPrimitive.Track
					...
					className="bg-muted relative overflow-hidden rounded-none select-none data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1"
				>
